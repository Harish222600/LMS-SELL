exports.resetPasswordTemplate = (email, resetLink, userName = 'User') => {
    ...
    <body>
        <div class="container">
            <div class="header">
                <img src="cid:beeja-logo" alt="LMS" style="max-width: 150px; margin-bottom: 15px;">
            ...
            <div class="content">
                ...
                <div class="message">
                    We received a request to reset the password for your LMS Platform account associated with <strong>${email}</strong>.
                </div>
            ...
            <div class="footer">
                <p>This email was sent from LMS Learning Platform. If you have any questions, please contact our support team.</p>
                <p>
